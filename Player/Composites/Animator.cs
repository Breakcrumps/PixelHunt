...
internal partial class Animator : Node
{
  ...
  )
  {
    ...
    if (_animPlayer.HasAnimation(animName))
    {
      ...
      if (Flags.Debug && _character is Enemy)
  ...
  public override void _Process(double delta)
  {
    ...
    if (
      _animPlayer.CurrentAnimation == "Unsheathe"
      || _animPlayer.CurrentAnimation == "RunUnsheathe"
    )
      ContinueUnsheathe();
  }
  ...
  internal void Unsheathe()
  {
    ...
    _horizontalVelocity = new(_character.Velocity.X, _character.Velocity.Z);
